...
class M_user extends CI_Model {
    ...
    var $id = 'id_user';
    var $table = 'yk_user';
    var $column_order = array(null,'fullname','username','status_user','buat_user','last_login','nama_group',null); //set column field database for datatable orderable
    var $column_search = array('fullname','username','status_user','buat_user','last_login','nama_group'); //set column field database for datatable searchable 
