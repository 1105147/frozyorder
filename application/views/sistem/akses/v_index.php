                                    ...
                                    <tr>
                                        ...
                                        <td nowrap>
                                            <div class="action-buttons">
                                                <a href="<?= site_url($module . '/add/' . encode($row['id_group'])) ?>" class="tooltip-success btn btn-white btn-success btn-sm" data-rel="tooltip" title="Tambah Hak Akses">
                                                    <span class="green">
                                                        <i class="ace-icon fa fa-plus-circle bigger-130"></i>
                                                    </span>
                                                </a>
                                                <a href="<?= site_url($module . '/edit/' . encode($row['id_group'])) ?>" class="tooltip-warning btn btn-white btn-warning btn-sm" data-rel="tooltip" title="Ubah Hak Akses">
                                                    <span class="orange">
