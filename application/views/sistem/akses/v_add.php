                        ...
                        <div class="clearfix">
                            ...
                            <select class="select2 width-100" name="user" id="user" data-placeholder="-------> Pilih User Aplikasi <-------">
                                ...
                                foreach ($user['data'] as $val) {
                                    echo '<option value="'.$val['id_user'].'">'.$val['fullname'].' - '.$val['username'].'</option>';
                                }
                                ?>
                            </select>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td nowrap>
                                        <div class="action-buttons">
                                            <a href="#" name="<?= encode($row['group_id']) ?>" itemprop="<?= encode($row['user_id']) ?>" id="delete-btn" class="tooltip-error btn btn-white btn-danger btn-sm" data-rel="tooltip" title="Hapus Data">
