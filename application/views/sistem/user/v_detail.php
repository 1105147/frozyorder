                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        ...
                                        <div class="profile-user-info">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span><?= format_date($user['buat_user'], 0) ?></span>
                                                </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name">
                                                ...
                                                <div class="profile-info-value">
                                                    <span><?= selisih_wkt($user['update_user']) ?></span>
                                                </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name">
                                            ...
                                            <div class="profile-info-row">
                                                <div class="profile-info-name">
                                                    <i class="middle ace-icon fa fa-newspaper-o bigger-150 blue"></i>
                                                </div>
                                                <div class="profile-info-value">
                                                    <span class="label label-info label-white arrowed"><?= $user['log_user'] ?></span>
                                                </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name">
                                                    <i class="middle ace-icon fa fa-laptop bigger-150 blue"></i>
                                                </div>
                                                <div class="profile-info-value">
                                                    <span class="label label-info label-white arrowed"><?= $user['ip_user'] ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /.col -->
