    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <form id="validation-form" action="<?= site_url($action); ?>" name="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-5 no-padding-right">Password :</label>
                    <div class="col-xs-12 col-sm-7">
                        <div class="clearfix">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-5 no-padding-right">Konfirmasi Password :</label>
                    <div class="col-xs-12 col-sm-7">
                        <div class="clearfix">
