                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= ($row['a']['status_menu'] == '1') ? 'Ya' : 'Tidak'; ?></td>
                                    <td><i class="<?= $row['a']['icon_menu']; ?> blue bigger-120"></i></td>
                                    <td><?= $row['a']['order_menu'] ?></td>
                                    <td nowrap>
                                        <div class="action-buttons">
                                            <a href="<?= site_url($module.'/edit/'.encode($row['a']['id_menu'])) ?>" class="tooltip-warning btn btn-white btn-warning btn-sm" data-rel="tooltip" title="Ubah Data">
                                                <span class="orange">
                                                    <i class="ace-icon fa fa-pencil-square-o bigger-130"></i>
                                                </span>
                                            </a>
                                            <a href="#" name="<?= encode($row['a']['id_menu']) ?>" itemprop="<?= $row['a']['nama_menu'] ?>" id="delete-btn" class="tooltip-error btn btn-white btn-danger btn-sm" data-rel="tooltip" title="Hapus Data">
